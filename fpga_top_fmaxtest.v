...
module fpga_top_fmaxtest (
    // CLK100MHZ here is the MMCM OUTPUT (test frequency), not the original 100MHz.
    // The MMCM lives in a separate wrapper (fmaxtest_wrapper.v), feeding this CLK100MHZ to the core.
    ...
    localparam CNT_MAX = 27'd0;  // FULL-SPEED: clk_en=1 every cycle to properly stress the critical path
