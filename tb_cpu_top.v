...
module tb_cpu_top;
    ...
    always @(posedge clk) begin
        ...
        check_reg( 3, 32'h00000003, "x3_ADD_fwd_chain"  );
        check_reg( 5, 32'h00000008, "x5_ADD_chain_end"  );
        check_reg( 6, 32'h00000007, "x6_SUB"            );
        check_reg( 7, 32'h0000000A, "x7_OR"             );
        check_reg( 8, 32'h0000000F, "x8_XOR"            );
        check_reg( 9, 32'h00000008, "x9_AND_fwd"        );
        check_reg(10, 32'hFFFFFFFB, "x10_ADDI_neg"      );
        check_reg(11, 32'h00000001, "x11_SLTI"          );
        check_reg(12, 32'h00000000, "x12_SLTIU"         );
        check_reg(13, 32'h0000000F, "x13_ANDI"          );
        check_reg(14, 32'h00000010, "x14_SLLI"          );
        check_reg(15, 32'hFFFFFFFD, "x15_SRAI"          );
        check_reg(16, 32'h00000004, "x16_SRLI"          );
        check_reg(17, 32'h00000001, "x17_SLT"           );
        check_reg(18, 32'h00000001, "x18_SLTU"          );
        check_reg(19, 32'h00000008, "x19_LW"            );
        check_reg(20, 32'h00000009, "x20_LoadUse_stall" );
